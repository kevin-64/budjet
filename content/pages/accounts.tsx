...
const AccountsContent = () => {
          ...
          setAccounts(
            docs.map((d) => {
              return {
                ...d,
                id: d._id,
                creationDate: moment(d.creationDate).format("MM/DD/YYYY"),
              };
            })
          );
        });
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params: GridCellParams) => {
        const onClick = () => {
          setIdToDelete(params.getValue(params.id, "id") as string);
      ...
      <div className={classes.tableContainer}>
        <DataGrid
          ...
          onRowDoubleClick={(row) =>
            history.push(`edit-accounts?id=${row.getValue(row.id, "id")}`)
          }
        />
      </div>
